...
#
#     def __init__(self, initial_filter_size: int, batch_size: int):
#         """
#         create a model with the given initial filter size and batch size
#         There are two types of models in this mehtod:
#         1.
#         """
#
